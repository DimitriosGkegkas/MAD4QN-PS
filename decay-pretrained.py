...
if __name__ == '__main__':
    ...
    trainer = MultiAgentTrainerParallel(args, num_env=9, algorithm_identifier='decay-preload',evaluation_step=10)
    ...
    trainer.preload("models/DuelingDDQNAgents-v1/26012025")
    trainer.train()
